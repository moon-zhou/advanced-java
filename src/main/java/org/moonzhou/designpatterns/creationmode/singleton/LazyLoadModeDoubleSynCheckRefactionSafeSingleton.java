 ...
 * @author moon zhou
 */
public class LazyLoadModeDoubleSynCheckRefactionSafeSingleton implements Singleton {

    private static LazyLoadModeDoubleSynCheckRefactionSafeSingleton INSTANCE;

    private static boolean flag = true;

    private LazyLoadModeDoubleSynCheckRefactionSafeSingleton() {
    ...
    public LazyLoadModeDoubleSynCheckRefactionSafeSingleton getInstance() {
        ...
        if (null == INSTANCE) {
            ...
            synchronized (LazyLoadModeDoubleSynCheckRefactionSafeSingleton.class) {
                ...
                if (null == INSTANCE) {
                     ...
                     */
                    INSTANCE = new LazyLoadModeDoubleSynCheckRefactionSafeSingleton();
                }
            }
        }
        return INSTANCE;
